...
pub use scred_readctor_framering::{PatternSelector, PatternTier};
pub use scred_readctor_framering::pattern_selector::{Severity, ServiceCategory, PatternKind, Origin};
