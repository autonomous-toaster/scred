...
fn print_help() {
    ...
    println!();
    println!("Pattern Detection & Redaction Options:");
    println!("  --detect <TYPES>        Which patterns to detect (default: ALL)");
    println!("                          Supports: CRITICAL, API_KEYS, INFRASTRUCTURE, SERVICES, PATTERNS");
    println!("                          Glob patterns: mysql*, aws-*, github-*, etc.");
    println!("                          Regex: regex:^(aws|github)");
    ...
    println!();
    println!("Pattern Tier Reference:");
    println!("  CRITICAL                AWS, GitHub, Stripe, OpenAI, MongoDB, PostgreSQL, JWT");
    println!("  API_KEYS                OpenAI, Anthropic, Google, Slack, Twilio, Azure, etc.");
    println!("  INFRASTRUCTURE          Kubernetes, Docker, Vault, Consul, Databricks, etc.");
    println!("  SERVICES                Payment processors, communication services, etc.");
    println!("  PATTERNS                Bearer tokens, BasicAuth, private keys, etc.");
    println!();
    println!("Environment Variables:");
    println!("  SCRED_DETECT_PATTERNS   Which patterns to detect (default: ALL)");
    println!("  SCRED_REDACT_PATTERNS   Which patterns to redact (default: ALL)");
    println!();
    println!("Usage Examples:");
    println!("  cat secrets.txt | scred                                    # Redacts ALL patterns");
